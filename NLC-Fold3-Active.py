...
data_dir = os.path.join( '/content/Peyman-Fold3/data/Fold3/')
...
output_dir = './content/Peyman-Fold3/output/'
...
def evaluate(model, predict_dataloader, batch_size, epoch_th, dataset_name):
    ...
    with open("/content/Peyman-Fold3/data/Fold3/train.txt", "w") as writer:
            ...
            nextfile=open("/content/Peyman-Fold3/data/Fold3/valid.txt", "w")
